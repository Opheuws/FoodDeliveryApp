...
public class RestaurantListAdapter extends RecyclerView.Adapter<RestaurantListAdapter.MyViewHolder> {
    ...
    public RestaurantListAdapter(List<RestaurantModel> restaurantModelList, RestaurantListClickListener clickListener) {
        ...
        this.clickListener = clickListener;  // Atrelando o evento de clique a lista
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull RestaurantListAdapter.MyViewHolder holder, int position) { //Posições de endereço e Hora
        holder.restaurantName.setText(restaurantModelList.get(position).getName());
        holder.restaurantAddress.setText("Endereço: "+restaurantModelList.get(position).getAddress());
        holder.restaurantHours.setText("Horarios: " + restaurantModelList.get(position).getHours().getTodaysHours());

        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                clickListener.onItemClick(restaurantModelList.get(position)); //Evento que leva ao Menu dos restaurantes
            }
        });
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder { //Informações que a recicler view vai pegar
    ...
    public interface RestaurantListClickListener { //Evento de Clique
