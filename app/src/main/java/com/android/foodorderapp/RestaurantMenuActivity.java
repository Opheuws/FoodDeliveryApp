...
public class RestaurantMenuActivity extends AppCompatActivity implements MenuListAdapter.MenuListClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle(restaurantModel.getName());    //Informações do Menu, também vem do Model
        ...
        initRecyclerView();
         ...
         buttonCheckout = findViewById(R.id.buttonCheckout); //Botão de checkout
        buttonCheckout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(itemsInCartList != null && itemsInCartList.size() <= 0) {
                    Toast.makeText(RestaurantMenuActivity.this, "Adicione itens ao carrinho", Toast.LENGTH_SHORT).show();
    ...
    private void initRecyclerView() {
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(this, 2)); //Definição de gerenciador de layout
