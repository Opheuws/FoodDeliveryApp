...
public class PlaceYourOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonPlaceYourOrder = findViewById(R.id.buttonPlaceYourOrder); //Botão de escolha
        ...
        switchDelivery.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override //Condições do botão de escolha, Retirnar no local ou entrega
    ...
    private void onPlaceOrderButtonClick(RestaurantModel restaurantModel) {
        if(TextUtils.isEmpty(inputName.getText().toString())) {
            inputName.setError("Por favor insira seu nome ");
            return;
        } else if(isDeliveryOn && TextUtils.isEmpty(inputAddress.getText().toString())) {
            inputAddress.setError("Por favor insira o endereço ");
            return;
